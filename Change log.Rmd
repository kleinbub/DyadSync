...
## v.1.3.2
#### 2025/03/10
* added ppg2beats for HRV analysis
* exported dyadsignal to create custom signals

## v.1.3.1
#### 2024/12/17
  *  renamed Category to Diary. CategoryIndex to category. Diary contains one or more categories, which contain more levels
  * new functions for Diaries: oneDiary() catSummary()
  * new utility function: is.color()
  * timeMaster now accepts fractional time
  * fixed windowed functions: winInter() byWin() rescaleByWin()
  * improvements to peakFinder and drawframes
  * Implemented the method for diff.rats()
  * crucial bugfix: peakfinder amplitudes were wrong
  * restructured peakFinder filtering procedure, including a FIR filter, 
    and changed arguments.
  * FINALLY! a seemingly reliable PPG2beats() function!!!
